...
void AShooterCharacter::OnJSONResponseReceived(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful)
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Cyan, TEXT("Parsing Objects..."));

	if (JsonObject->TryGetArrayField("objects", ObjectsArray))
	{
		//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, TEXT("objects found"));
		...
		{   
			...
			FString Msg = FString::Printf(TEXT("Type: %s"), *TypeName);
			//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Green, Msg);

			TSharedPtr<FJsonObject> TransformObj = Obj->GetObjectField("transform");

			//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Green, TEXT("Transform Found"));
			...
			if (TransformObj->TryGetArrayField("location", LocationArray))
			{
				...
				//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, TEXT("Before Spawn"));
